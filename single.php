		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post-header section">
				...
				<div class="post-header-inner section-inner medium">
					...
					<p class="post-meta-top"><a href="<?php the_permalink(); ?>" title="<?php the_time( get_option( 'time_format' ) ); ?>"><?php the_time( get_option( 'date_format' ) ); ?></a> <?php if ( comments_open() ) { echo '<span class="sep">/</span> '; comments_popup_link( '0 comments', '1 comment', '% comments', 'post-comments' ); } ?> <?php edit_post_link( 'Edit', '<span class="sep">/</span> ' ); ?></p>
